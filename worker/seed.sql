-- All-zeros UUID (with the v4/variant bits set so it's a syntactically valid
-- v4) — obviously synthetic, can never collide with a real client-generated
-- crypto.randomUUID() value, so reseeding can't trample real practice data.
